...
@typechecked
def jsonl_to_json(jsonl_in: pathlib.Path, folder_out: pathlib.Path, id_element: str, sub_process_count: int) -> None:
    """
...
if __name__ == '__main__':
    ...
    jsonl_to_json(args.jsonl_in, args.folder_out, args.id_element, args.sub_process_count)
